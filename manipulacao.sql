...
insert into funcionarios(id_funcionarios,nome,cpf,data_nascimento, endereco,telefone,email,cargo,salario,data_admissao) values
...
insert into pedidos(id_cliente, id_funcionarios, id_produto, quantidade,data_pedido, Estatus) values
...
-- atualizar o CPF 444.555.666-77
